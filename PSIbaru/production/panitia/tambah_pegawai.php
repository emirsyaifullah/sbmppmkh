...
<?php
	...
	$nama10=$_POST['TALAMAT_PEG'];
	
	$cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM pegawai WHERE ID_PANITIA='$nama7'"));
    if ($cek > 0){
    echo 
	"<script>window.alert('Data pegawai yang Anda Masukkan Sudah Ada')
    window.location='data_pegawai.php'</script>";
    }else {
	
	//buat query input
	$pegawai="insert into pegawai (ID_PANITIA,ID_JABATAN,ID_KOTA,NAMA_PEG, TGL_LHR_PEG, JK_PEG, TLP_PEG, EMAIL_PEG, ALAMAT_PEG, USERNAME, PASSWORD)
	values('$nama7', '$nama8','$nama6','$nama','$nama9','$nama1','$nama2','$nama3','$nama10','$nama4','$nama5')";
	$result=mysqli_query($koneksi,$pegawai);
		if($result)
		{
			header("location:data_pegawai.php?pesan=<p class='berhasil'>Data Berhasil disimpan</p>");
		}
		else
		{
			echo "=<p class='gagal'>Data tidak berhasil disimpan</p>";
		}
	}
	}
?>
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="ID_PANITIA" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="NAMA_PEG" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="TGL_LHR_PEG" required="required" type="date">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="TLP_PEG" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="EMAIL_PEG" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="ALAMAT_PEG" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="PASSWORD" required="required" type="text">
                        </div>
                      </div>
