...
<?php
	//menampilkan data
	$data1="select * from periode where ID_PERIODE='$_GET[ID_PERIODE]'";
	...
	//buat variabel
	$nama=$_POST['PERIODE'];
	$nama1=$_POST['ID_TAHUN'];
//	$nama2=$_POST['KUOTA'];
	$nama3=$_POST['TGL_UJIAN'];
	$nama4=$_POST['TGL_PENGUMUMAN'];
		
	//buat query ubah
	$data2="update periode set ID_TAHUN='$nama1', PERIODE='$nama', TGL_UJIAN='$nama3', TGL_PENGUMUMAN='$nama4'
	where ID_PERIODE='$_GET[ID_PERIODE]'";
	$hasil2=mysqli_query($koneksi,$data2);
		if($hasil2){
		header("location:data_periode.php");
		}else{
		echo 
			"<script>window.alert('data gagal di edit!')
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <span class="section">Edit Periode </span>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
							 <div class="btn-group">
								<select name="ID_TAHUN" class="options">
								<option value="0" selected>- Pilih Tahun -</option>
									<?php
									$j=mysqli_query($koneksi,"select * from tahun order by ID_TAHUN");
									while($k=mysqli_fetch_array($j)){
									$pilih=($k['ID_TAHUN']==$result1['ID_TAHUN']?"selected":"");
									echo "<option value='$k[ID_TAHUN]'$pilih>$k[TAHUN]</option>";
									}
									?>
								</select>
							 </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="periode" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="PERIODE" required="required" type="text" value="<?php echo $result1['PERIODE']; ?>">
                        </div>
                      </div>

                      
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periode">Tanggal Ujian <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="periode" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="TGL_UJIAN" required="required" type="text" value="<?php echo $result1['TGL_UJIAN']; ?>">
                        </div>
                      </div>
                      
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periode">Tanggal Pengumuman <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="periode" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="TGL_PENGUMUMAN" required="required" type="text" value="<?php echo $result1['TGL_PENGUMUMAN']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a href="data_periode.php"><input type="button" name="batal" value="Batal" class="btn btn-primary"></a>
