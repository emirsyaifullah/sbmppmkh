...
<?php
	//menampilkan data
	$data1="select * from ujian where ID_UJIAN='$_GET[ID_UJIAN]'";
	...
	//buat query ubah
	$data2="update ujian set TGL_UJIAN='$nama', TGL_PENGUMUMAN='$nama'
	where ID_UJIAN='$_GET[ID_UJIAN]'";
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <span class="section">Edit Data Tanggal Seleksi</span>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periode">Tanggal Seleksi <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="tgl_ujian" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="TGL_UJIAN" required="required" type="date" value="<?php echo $result1['TGL_UJIAN']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="tgl_pengumuman" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="TGL_PENGUMUMAN" required="required" type="date" value="<?php echo $result1['TGL_PENGUMUMAN']; ?>">
                        </div>
                      </div>
