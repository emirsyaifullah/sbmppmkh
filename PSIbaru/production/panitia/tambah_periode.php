...
//	$cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM periode WHERE ='$nama'"));
//    if ($cek > 0){
//    echo 
//	"<script>window.alert('periode yang Anda Masukkan Sudah Ada')
//    window.location='data_periode.php'</script>";
//    }else {
	
	//buat query input
	$PERIODE="insert into periode (ID_TAHUN, PERIODE, TGL_UJIAN, TGL_PENGUMUMAN)
	values('$nama1', '$nama', '$nama3', '$nama4')";
	$result=mysqli_query($koneksi,$PERIODE);
		if($result)
		{
			header("location:data_periode.php?pesan=<p class='berhasil'>Data Berhasil disimpan</p>");
		}
		else
		{
			echo 
			"<script>window.alert('gagal menyimpan data periode!')
    		window.location='data_periode.php'</script>";
	}
//	}
	}
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <span class="section">Tambah Periode </span>
                     ...
                     <div class="btn-group">
						...
						<option value="0" selected>- Pilih Tahun -</option>
							<?php
							$j=mysqli_query($koneksi,"select * from tahun ORDER BY TAHUN");
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="periode" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="PERIODE" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="kuota" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="TGL_UJIAN" required="required" type="date">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="kuota" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="TGL_PENGUMUMAN" required="required" type="date">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a href="data_periodePendaftaran.php"><input type="button" name="batal" value="Batal" class="btn btn-primary"></a>
