          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
             <div class="x_content">
                    ...
                    <div class="section" align="center"><a href="tambah_kota.php"><img src="img/tambah.png" width="40" height="40"></a></div>
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            <th width="8%" align="center" class="column-title">No </th>
                            <th width="37%" align="center" class="column-title">Id Kota </th>
                            <th width="34%" align="center" class="column-title">Nama Kota </th>
                        ...
                        <tbody>
						 ...
						 ?>
                          <tr class="even pointer">
            				...
            				<a title="edit" href="edit_kota.php?ID_KOTA=<?php echo $data[0];?>"><img src="img/edit1.png" width="15" height="15" /></a> |
            				<a title="cetak" href="javascript:if(confirm('Anda yakin menghapus?')){document.location='hapus_kota.php?ID_KOTA=<?php echo $data[0]; ?>';}"><img src="img/delete.png" width="15" height="15" /></a>
                            </td>
                          </tr>
                         <?php
						  }
