...
<?php
	...
	//buat variabel
	$nama=$_POST['TGL_UJIAN'];
	$nama1=$_POST['TGL_PENGUMUMAN'];
	
	$cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM ujian WHERE TGL_UJIAN='$nama' AND TGL_PENGUMUMAN='$nama1'"));
    if ($cek > 0){
    echo 
	"<script>window.alert('Kota yang Anda Masukkan Sudah Ada')
    window.location='data_tglseleksi.php'</script>";
    }else {
	
	//buat query input
	$tgl="insert into ujian (TGL_UJIAN, TGL_PENGUMUMAN)
	values('$nama','$nama1')";
	$result=mysqli_query($koneksi,$tgl);
		if($result)
		{
			header("location:data_tglseleksi.php?pesan=<p class='berhasil'>Data Berhasil disimpan</p>");
		}
		else
		{
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <span class="section">Tambah Data Tanggal Ujian</span>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periode">Tanggal Seleksi <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="TGL_UJIAN" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="TGL_UJIAN" required="required" type="date">
                        </div>
                      </div>
                      
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periode">Tanggal Pengumuman Seleksi <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="TGL_PENGUMUMAN" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="TGL_PENGUMUMAN" required="required" type="date">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a href="data_tglseleksi.php"><input type="button" name="batal" value="Batal" class="btn btn-primary"></a>
