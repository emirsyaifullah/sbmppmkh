...
<?php
	//menampilkan data
	$data1="select calon_santri.ID_CS, calon_santri.NAMA_CS, calon_santri.STATUS_SELEKSI
	from calon_santri 
	...
	//buat variabel
	$nama1=$_POST['STATUS_SELEKSI'];
	
	//buat query ubah
	$data2="update calon_santri set STATUS_SELEKSI='$nama1'
	where ID_CS='$_GET[ID_CS]'";
	$hasil2=mysqli_query($koneksi,$data2);
		
	echo 
	"<script>window.alert('data berhasil di simpan')
    window.location='data_hasilseleksi.php'</script>";
	}
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <span class="section">Edit Data Hasil Seleksi</span>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periode">Nama Santri <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12"><?php echo $result1['NAMA_CS']; ?>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="radio" name="STATUS_SELEKSI" value="DITERIMA" <?php if($result1['STATUS_SELEKSI']=="DITERIMA"){ echo "checked"; }?>><font class="ket_button">Diterima</font> &nbsp;&nbsp;&nbsp;
							<input type="radio" name="STATUS_SELEKSI" value="TIDAK DITERIMA" <?php if($result1['STATUS_SELEKSI']=="TIDAK DITERIMA"){ echo "checked"; }?>><font class="ket_button">Tidak Diterima</font>  
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a href="data_hasilseleksi.php"><input type="button" name="batal" value="Batal" class="btn btn-primary"></a>
