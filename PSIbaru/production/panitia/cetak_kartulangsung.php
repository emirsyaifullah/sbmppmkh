...
$a=$_REQUEST['ID_CS'];
				...
				//menampilkan data
				$data1=mysqli_fetch_array(mysqli_query($koneksi, "select calon_santri.ID_CS, calon_santri.NAMA_CS, calon_santri.JK_CS, kota.NAMA_KOTA, calon_santri.TGL_LHR_CS, calon_santri.NO_HP_CS, calon_santri.KULIAH , calon_santri.JURUSAN , calon_santri.SEMESTER ,calon_santri.FOTO, periode.PERIODE, tahun.TAHUN 
				from calon_santri, kecamatan, kota, periode, tahun, detil
				where calon_santri.ID_KEC=kecamatan.ID_KEC AND kecamatan.ID_KOTA=kota.ID_KOTA AND detil.ID_CS=calon_santri.ID_CS AND detil.ID_PERIODE=periode.ID_PERIODE AND periode.ID_TAHUN=tahun.ID_TAHUN AND calon_santri.ID_CS='$a' limit 1"));
...
<table  align="center" style="width: 100%; text-align: center; font-size: 20px">
        <tr><td style="width:10%" rowspan="4" align="center"><img src="../calonSantri/images/ppm.png" width='80' align="center"></td>
        ...
        <tr>
        <td class="style37"><font style="font-size:15px;"><b><?php echo $data1[10];?>, <?php echo $data1[11];?> </b></font></td>
        </tr>
</table>
...
<table width="100%" height="" border="0" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="font_tabel">
	...
	<td rowspan="6"> 
    	<img src="../calonSantri/uploadfoto/<?php echo $data1[9];?>" width='150' height='200'> </td>
	</tr>
