...
$hasil=mysqli_query($koneksi,"select calon_santri.ID_CS, calon_santri.NAMA_CS, daftar_ulang.TOTAL_DU, daftar_ulang.STATUS_BAYAR, daftar_ulang.TGL_DU
from daftar_ulang, calon_santri 
where daftar_ulang.ID_CS=calon_santri.ID_CS and STATUS_BAYAR!='BELUM LUNAS'")
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
             <div class="x_content">
				<div class="x_title">
                   ...
                   <form action="" method="POST" >
					<table height="" border="0" align="center" bgcolor="#FFFFFF"  style="margin-left:38%">
	   				 <tr>
       				   <td>
       				   <input type="text" list="daftar" id="santri" name="santri" required >
					<datalist id="daftar">
					<?php 
					include "koneksi.php";
					$qry=mysqli_query($koneksi,"select daftar_ulang.ID_DU, calon_santri.NAMA_CS, calon_santri.STATUS_SELEKSI, daftar_ulang.STATUS_BAYAR from calon_santri, daftar_ulang
					where daftar_ulang.ID_CS=calon_santri.ID_CS AND seleksi.STATUS_SELEKSI='DITERIMA'");
					while ($t=mysqli_fetch_array($qry)) {
					echo "<option value='$t[ID_CS]'>";
					}
					?></datalist>
					   </td>
					   <td>&nbsp;&nbsp;&nbsp;</td>
					   <td>
						<input type="submit" name="submit" value="Input" onclick="pesan();" class="btn btn-success">
					   </td>
        			</tr>
					</table>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th align="center" class="column-title">Total Pembayaran </th>
                        ...
                        <tbody>
						 ...
						 ?>
                          <tr class="even pointer">
                            ...
                            <td class=" last">
            				<a title="edit" href="edit_daftarulang.php?ID_CS=<?php echo $data[0];?>"><img src="img/edit1.png" width="15" height="15" /></a>|
                           <a title="edit" href="cetak_buktidafullangsung.php?ID_CS=<?php echo $data[0];?>"><img src="img/printer.png" width="15" height="15" /></a>
                            </td>
                          </tr>
                         <?php
						  }
				...
				<?php
		  	$tgl= date('d-m-Y');
		  	if(isset($_REQUEST['santri'])){
//				$message = "Wkwkwkw ";
//					echo "<script type='text/javascript'>alert('$message');</script>";
					@$sis = $_REQUEST['santri'];
					  mysqli_query($koneksi, "INSERT INTO daftar_ulang (ID_CS, TGL_DU, TOTAL_DU, STATUS_BAYAR, BUKTI_DU) VALUES ('$sis','$tgl','686.000','Lunas','')");
					echo '<meta http-equiv="refresh" content="0; URL=data_daftarulang.php">';
			}
...
function pesan(){
var number=document.getElementById("santri").value;
//confirm("Apakah id calon santri yang anda masukan ini "+number+" sudah benar ");
alert("Apakah id calon santri yang anda masukan ini "+number+" sudah benar");
}
</script>
    <!-- jQuery -->
