...
<?php
	//menampilkan data
	$data1="select * from jabatan where ID_JABATAN='$_GET[ID_JABATAN]'";
	...
	//buat query ubah
	$data2="update JABATAN set NAMA_JABATAN='$nama'
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <span class="section">Edit Data Jabatan</span>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periode">Nama Jabatan <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="NAMA_JABATAN" required="required" type="text" value="<?php echo $result1['NAMA_JABATAN']; ?>">
                        </div>
