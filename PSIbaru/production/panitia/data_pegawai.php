          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
             <div class="x_content">
                    ...
                    <div class="section" align="center"><a href="tambah_pegawai.php"><img src="img/tambah.png" width="40" height="40"></a></div>
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            <th align="center" class="column-title">No </th>
                            <th align="center" class="column-title">Id Pegawai</th>
                            <th align="center" class="column-title">Jabatan</th>
                            <th align="center" class="column-title">Nama </th>
                            <th align="center" class="column-title">Telepon </th>
                        ...
                        <tbody>
                         ...
                         <?php
							$a="select pegawai.ID_PANITIA, jabatan.NAMA_JABATAN, pegawai.NAMA_PEG, pegawai.TLP_PEG 
							from pegawai, jabatan 
							WHERE pegawai.ID_JABATAN = jabatan.ID_JABATAN ORDER BY pegawai.ID_PANITIA";
							@$i=0; 
						 ...
						 ?>
                          <tr class="even pointer">
                            ...
                            <td class=" last">
            				<a title="edit" href="edit_pegawai.php?ID_PANITIA=<?php echo $data[0];?>"><img src="img/edit1.png" width="15" height="15" /></a> |
            				<a title="cetak" href="javascript:if(confirm('Anda yakin menghapus?')){document.location='hapus_pegawai.php?ID_PANITIA=<?php echo $data[0]; ?>';}"><img src="img/delete.png" width="15" height="15" /></a>
                            </td>
                          </tr>
                         <?php
						  }
