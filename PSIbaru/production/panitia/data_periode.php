          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
             <div class="x_content">
                    ...
                    <span class="section">Periode</span>
                    <div class="section" align="center"><a href="tambah_periode.php"><img src="img/tambah.png" width="40" height="40"></a></div>
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            <th align="center" class="column-title">No </th>
                            <th align="center" class="column-title">Id </th>
                            <th align="center" class="column-title">Periode - Tahun</th>
                        ...
                        <tbody>
                         ...
                         <?php
							$a="select periode.ID_PERIODE, periode.PERIODE, tahun.TAHUN from periode, tahun where periode.ID_TAHUN=tahun.ID_TAHUN GROUP BY periode.ID_PERIODE ASC";
							@$i=0; 
						 ...
						 ?>
                          <tr class="even pointer">
                            ...
                            <td class=" "><?php echo $data[1]; ?> - <?php echo $data[2]; ?></td>
                            <td class=" last">
            				<a title="edit" href="edit_periode.php?ID_PERIODE=<?php echo $data[0];?>"><img src="img/edit1.png" width="15" height="15" /></a>
                            </td>
                          </tr>
                         <?php
						  }
