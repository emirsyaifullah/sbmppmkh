<?php
include("koneksi.php");
$hasil=mysqli_query($koneksi,"select calon_santri.ID_CS, calon_santri.NAMA_CS, calon_santri.JK_CS, calon_santri.ALAMAT_CS, calon_santri.STATUS  
from calon_santri");
?>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
             <div class="x_content">
				<div class="x_title">
                    <h2>Data Calon Santri Pendaftar</h2>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                         ...
                         <?php
							$a="select calon_santri.ID_CS, calon_santri.NAMA_CS, calon_santri.JK_CS, calon_santri.ALAMAT_CS, periode.PERIODE, tahun.TAHUN
							from calon_santri, tahun, periode, detil where detil.ID_CS=calon_santri.ID_CS AND detil.ID_PERIODE=periode.ID_PERIODE AND periode.ID_TAHUN=tahun.ID_TAHUN GROUP BY calon_santri.ID_CS ASC";
							@$i=0; 
						 ...
						 ?>
                          <tr class="even pointer">
                            ...
                            <td class=" last">
                            <a title="detail" href="detail_formDaftarLangsung.php?ID_CS=<?php echo $data[0];?>"><img src="img/a.png" width="15" height="15" /></a> |
            				<a title="edit" href="edit_formDaftarLangsung.php?ID_CS=<?php echo $data[0];?>"><img src="img/edit1.png" width="15" height="15" /></a> |
            				<a title="cetak" href="cetak_kartulangsung.php?ID_CS=<?php echo $data[0];?>"><img src="img/kartu.png" width="15" height="15" /></a>
                            </td>
                          </tr>
                         <?php
						  }
