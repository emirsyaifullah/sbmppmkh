                   ...
                   <table height="" border="0" align="center" bgcolor="#FFFFFF"  style="margin-left:38%">
	   				 <tr align="left">
       				   ...
       				   <select name="periode" id="periode" class="options">
							...
							<?php
							   $j=mysqli_query($koneksi,"select * from periode, tahun WHERE periode.ID_TAHUN=tahun.ID_TAHUN ORDER BY TAHUN");
       					...
       					<td>&nbsp;&nbsp;&nbsp;</td>
						<td><input type="submit" name="simpan" value="pilih" class="btn btn-success">
					   </td>
        			</tr>
					</table>
                   </form>
                        ...
                        <tbody>
						 ...
						 ?>
                          <tr class="even pointer">
                            ...
                            <td class=" last">
            				<a title="edit" href="edit_hasilseleksi.php?ID_CS=<?php echo $data[0];?>"><img src="img/edit1.png" width="15" height="15" /></a>
                            </td>
                          </tr>
                         <?php
						  $isi += ($i);}
