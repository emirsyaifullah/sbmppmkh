...
<?php
	//menampilkan data
	$data1="select daftar_ulang.ID_DU, calon_santri.ID_CS, calon_santri.NAMA_CS, daftar_ulang.STATUS_BAYAR, daftar_ulang.BUKTI_DU
	from calon_santri, daftar_ulang
	where daftar_ulang.ID_CS=calon_santri.ID_CS AND calon_santri.ID_CS='$_GET[ID_CS]'";
	$hasil1=mysqli_query($koneksi,$data1);
	$result1=mysqli_fetch_array($hasil1);

	$hasil=mysqli_query($koneksi,"select * from daftar_ulang where ID_DU =(select ID_DU from daftar_ulang where ID_CS='$_GET[ID_CS]')");
	$hasil = mysqli_fetch_array($hasil);
	$bukti = $hasil['BUKTI_DU'];
	...
	$id_du=$_GET['ID_DU'];
	$nama=$_POST['NAMA_CS'];
	$nama1=$_POST['STATUS_BAYAR'];
	
	//buat query ubah
	$data2="update daftar_ulang set STATUS_BAYAR='$nama1'
	where ID_CS='$_GET[ID_CS]'";
	$hasil2=mysqli_query($koneksi,$data2);
		if($hasil2){
				header("location:data_daftarulang.php?pesan=Data berhasil disimpan");
		}else{
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <span class="section">Edit Data Daftar Ulang</span>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periode">Nama Santri <span class="required">*</span>
                        </label>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="radio" name="STATUS_BAYAR" value="LUNAS" <?php if($result1['STATUS_BAYAR']=="LUNAS"){ echo "checked"; }?>><font class="ket_button">Lunas</font> &nbsp;&nbsp;&nbsp;
							<input type="radio" name="STATUS_BAYAR" value="BELUM LUNAS" <?php if($result1['STATUS_BAYAR']=="BELUM LUNAS"){ echo "checked"; }?>><font class="ket_button">Belum Lunas</font>  &nbsp;&nbsp;&nbsp;
							<input type="radio" name="STATUS_BAYAR" value="Belum Di verifikasi" <?php if($result1['STATUS_BAYAR']=="Belum Di verifikasi"){ echo "checked"; }?>><font class="ket_button">Belum di verifikasi</font>   
                        </div>
                      </div>
					  ...
					  ?>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periode"> <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          </div>
                      </div>
                      ...
                      <div class="attachment">
                            <p>
                              <span><i class="fa fa-paperclip"></i> Bukti pembayaran daftar ulang </span>
                            </p>
                            <ul>
                              <li>
                                <a href="<?php echo "../calonSantri/uploadfoto/".$result1['BUKTI_DU']; ?>" class="atch-thumb">
                                 <?php
								echo "<img src='../calonSantri/uploadfoto/".$result1['BUKTI_DU']."' alt=\"img\"/>"; ?>
                                </a>

                                <div class="file-name">
                                  <?php echo $result1['BUKTI_DU']; ?>
                                </div>
                              </li>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a href="data_daftarulang.php"><input type="button" name="batal" value="Batal" class="btn btn-primary"></a>
