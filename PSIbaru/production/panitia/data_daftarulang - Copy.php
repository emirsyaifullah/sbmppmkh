...
$hasil=mysqli_query($koneksi,"select daftar_ulang.ID_DU, calon_santri.ID_CS, calon_santri.NAMA_CS, daftar_ulang.STATUS_BAYAR, daftar_ulang.TGL_DU
from daftar_ulang, seleksi, calon_santri 
where daftar_ulang.ID_SELEKSI=seleksi.ID_SELEKSI AND seleksi.ID_CS=calon_santri.ID_CS")
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th align="center" class="column-title">Id Daftar Ulang </th>
                        ...
                        <tbody>
						 ...
						 ?>
                          <tr class="even pointer">
                            ...
                            <td class=" last">
            				<a title="edit" href="edit_hasilseleksi.php?ID_DU=<?php echo $data[0];?>"><img src="img/edit1.png" width="15" height="15" /></a>
                            </td>
                          </tr>
                         <?php
						  }
