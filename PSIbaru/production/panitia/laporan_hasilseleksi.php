				...
				<div class="x_title">
                   ...
                   <form action="" method="POST" >
					<table height="" border="0" align="center" bgcolor="#FFFFFF"  style="margin-left:38%">
	   				 <tr>
       				   <td>
						<select name="tahun_seleksi" id="periode" class="options">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th align="center" class="column-title">Total Nilai </th>
                       ...
                       <span align="center" style="margin-left: 20px">
						...
						<?php } else{ ?>
						<a href="cetak_laporanhasilseleksi.php?ID_PERIODE=<?php echo $_REQUEST['tahun_seleksi'];?>">
