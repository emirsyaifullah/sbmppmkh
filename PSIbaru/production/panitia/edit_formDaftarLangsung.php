...
<?php
	$data1="select * from calon_santri, kecamatan, kota, provinsi, akun where calon_santri.ID_KEC=kecamatan.ID_KEC AND kecamatan.ID_KOTA=kota.ID_KOTA AND kota.ID_PROV=provinsi.ID_PROV AND calon_santri.EMAIL=akun.EMAIL AND ID_CS='$_GET[ID_CS]'";
