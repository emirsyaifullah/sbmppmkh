...
<?php
	...
	$cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM kota WHERE NAMA_KOTA='$nama'"));
    if ($cek > 0){
    echo 
	"<script>window.alert('Kota yang Anda Masukkan Sudah Ada')
    window.location='data_kota.php'</script>";
    }else {
	
	//buat query input
	$jabatan="insert into kota (NAMA_KOTA)
	values('$nama')";
	$result=mysqli_query($koneksi,$jabatan);
		if($result)
		{
			header("location:data_kota.php?pesan=<p class='berhasil'>Data Berhasil disimpan</p>");
		}
		else
		{
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <span class="section">Tambah Data Kota</span>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periode">Nama Kota <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="NAMA_KOTA" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a href="data_kota.php"><input type="button" name="batal" value="Batal" class="btn btn-primary"></a>
