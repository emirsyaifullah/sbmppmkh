...
@$peiode=$_REQUEST['periode'];
$hasil=mysqli_query($koneksi,"select calon_santri.ID_CS, calon_santri.NAMA_CS, calon_santri.TEMPAT_LHR_CS, calon_santri.TGL_LHR_CS, calon_santri.JK_CS, calon_santri.ALAMAT_CS, calon_santri.KULIAH, calon_santri.JURUSAN, calon_santri.SEMESTER ,periode.PERIODE, tahun.ID_TAHUN
from calon_santri, periode, tahun, detil
where detil.ID_CS=calon_santri.ID_CS AND detil.ID_PERIODE=periode.ID_PERIODE AND periode.ID_TAHUN=tahun.ID_TAHUN AND periode.ID_PERIODE='$peiode' GROUP BY periode.ID_PERIODE");
?>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th align="center" class="column-title">Tempat, tanggal lahir </th>
                            <th align="center" class="column-title">Jenis Kelamin </th>
                            <th align="center" class="column-title">Alamat </th>
                            <th align="center" class="column-title">Kuliah </th>
                            <th align="center" class="column-title">Jurusan </th>
                            <th align="center" class="column-title">Semester </th>
                          </tr>
                        </thead>
                        ...
                        <tbody>
						 ...
						 ?>
                          <tr class="even pointer">
                            ...
                            <td class=" "><?php echo $data[2]; ?>,<?php echo $data[3]; ?></td>
                            <td class=" "><?php echo $data[4]; ?></td>
                            <td class=" "><?php echo $data[5]; ?></td>
                            <td class=" "><?php echo $data[6]; ?></td>
                            <td class=" "><?php echo $data[7]; ?></td>
                            <td class=" "><?php echo $data[8]; ?></td>
                          </tr>
                         <?php
						 $isi += ($i); }
						 ?> 
                       <span align="center" style="margin-left: 20px">
						...
						<?php } else{ ?>
						<a href="cetak_laporanpendaftaran.php?ID_PERIODE=<?php echo $_REQUEST['periode'];?>">
