<?php
include("koneksi.php");
$hasil=mysqli_query($koneksi,"select calon_santri.ID_CS, calon_santri.NAMA_CS, calon_santri.TOTAL_NILAI, periode.PERIODE, tahun.TAHUN from calon_santri, detil, periode, tahun WHERE detil.ID_CS=calon_santri.ID_CS AND detil.ID_PERIODE=periode.ID_PERIODE AND periode.ID_TAHUN=tahun.ID_TAHUN GROUP BY calon_santri.ID_CS");
?>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th align="center" class="column-title">Nilai Ujian </th>
                        ...
                        <tbody>
						 ...
						 ?>
                          <tr class="even pointer">
                            ...
                            <td class=" "><?php echo $data[4]; ?>-<?php echo $data[3]; ?></td>
                            <td class=" "><?php echo $data[2]; ?></td>
                            <td class=" last">
            				<a title="detail nilai" href="detail_penilaianseleksi.php?ID_CS=<?php echo $data[0];?>"><img src="img/a.png" width="15" height="15" /></a>
                            </td>
                          </tr>
                         <?php
						  }
