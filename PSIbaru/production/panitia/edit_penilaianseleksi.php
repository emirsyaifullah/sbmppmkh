...
<?php
	...
	//buat query ubah
	$total=$nama1+$nama2+$nama3;
	$data2="update detil set NILAI='$nama1'
	where ID_CS='$_GET[ID_CS]' AND ID_UJIAN='1'";
	$hasil2=mysqli_query($koneksi,$data2);
		
	$data5="update detil set NILAI='$nama2'
	where ID_CS='$_GET[ID_CS]' AND ID_UJIAN='2'";
	$hasil5=mysqli_query($koneksi,$data5);
	
	$data6="update detil set NILAI='$nama3'
	where ID_CS='$_GET[ID_CS]' AND ID_UJIAN='3'";
	$hasil6=mysqli_query($koneksi,$data6); 
		
	$data7="update calon_santri set TOTAL_NILAI='$total'
	where ID_CS='$_GET[ID_CS]'";
	$hasil7=mysqli_query($koneksi,$data7); 
	echo 
	"<script>window.alert('nilai berhasil di simpan')
    window.location='data_seleksi.php'</script>";
	}
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                     ...
                     <span class="section">Edit Nilai</span>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nilai1" required="required" type="text" value="<?php echo $result1['NILAI']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nilai2" required="required" type="text" value="<?php echo $result3['NILAI']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nilai3" required="required" type="text" value="<?php echo $result4['NILAI']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a href="data_seleksi.php"><input type="button" name="batal" value="Batal" class="btn btn-primary"></a>
