...
<?php
	//menampilkan data
	$data1="select * from tahun where ID_TAHUN='$_GET[ID_TAHUN]'";
	...
	//buat query ubah
	$data2="update tahun set TAHUN='$nama1'
	where ID_TAHUN='$_GET[ID_TAHUN]'";
	$hasil2=mysqli_query($koneksi,$data2);
		if($hasil2){
		header("location:data_tahun.php");
		}else{
		echo 
			"<script>window.alert('data gagal diUBAH')
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <span class="section">Edit Data Tahun</span>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periode">Tahun <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="TAHUN" required="required" type="text" value="<?php echo $result1['TAHUN']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a href="data_tahun.php"><input type="button" name="batal" value="Batal" class="btn btn-primary"></a>
