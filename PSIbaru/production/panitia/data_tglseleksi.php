          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
             <div class="x_content">
                    ...
                    <span class="section">Data Tanggal Ujian Seleksi</span>
                    <div class="section" align="center"><a href="tambah_tglseleksi.php"><img src="img/tambah.png" width="40" height="40"></a></div>
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            <th width="8%" align="center" class="column-title">No </th>
                            <th width="37%" align="center" class="column-title">Id Tanggal </th>
                            <th width="34%" align="center" class="column-title">Tanggal Seleksi </th>
                            <th width="34%" align="center" class="column-title">Tanggal Pengumuman </th>
                        ...
                        <tbody>
						 ...
						 ?>
                          <tr class="even pointer">
            				...
            				<a title="edit" href="edit_tglseleksi.php?ID_UJIAN=<?php echo $data[0];?>"><img src="img/edit1.png" width="15" height="15" /></a> |
            				<a title="cetak" href="javascript:if(confirm('Anda yakin menghapus?')){document.location='hapus_tglseleksi.php?ID_UJIAN=<?php echo $data[0]; ?>';}"><img src="img/delete.png" width="15" height="15" /></a>
                            </td>
                          </tr>
                         <?php
						  }
