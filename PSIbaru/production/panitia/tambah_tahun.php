...
<?php
	...
	$cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tahun WHERE TAHUN='$nama1'"));
    if ($cek > 0){
    echo 
	"<script>window.alert('Tahun yang Anda Masukkan Sudah Ada')
    window.location='data_tahun.php'</script>";
    }else {
	
	//buat query input
	$tahun_PERIODE="insert into tahun (TAHUN)
	values('$nama1')";
	$result=mysqli_query($koneksi,$tahun_PERIODE);
		if($result)
		{
		...
		{
			echo 
			"<script>window.alert('data gagal disimpan!')
    		window.location='data_tahun.php'</script>";
		}
	}
	}
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <span class="section">Tambah Tahun</span>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="periode">Tahun <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="tahun" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="TAHUN" required="required" type="text">
                        </div>
                      </div>
