          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
             <div class="x_content">
                    ...
                    <span class="section">Data Tahun</span>
                    <div class="section" align="center"><a href="tambah_tahun.php"><img src="img/tambah.png" width="40" height="40"></a></div>
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            <th align="center" class="column-title">No </th>
                            <th align="center" class="column-title">Id Tahun </th>
                            <th align="center" class="column-title">Tahun </th>
                        ...
                        <tbody>
						 ...
						 ?>
                          <tr class="even pointer">
                            ...
                            <td class=" last">
            				<a title="edit" href="edit_tahun.php?ID_TAHUN=<?php echo $data[0];?>"><img src="img/edit1.png" width="15" height="15" /></a>
                            </td>
                          </tr>
                         <?php
						  }
