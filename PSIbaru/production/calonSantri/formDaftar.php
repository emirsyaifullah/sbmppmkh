...
<?php
	...
	//mencari id akun	
	$daftar = "select EMAIL as last_idAkun from akun where EMAIL = '$idcusc'";
	...
	$cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM calon_santri WHERE EMAIL='$lastIdAkun'"));
    if ($cek > 0){
    echo 
	"<script>window.alert('Anda Telah Melakukan Pendaftaran')
    window.location='formDaftar.php'</script>";
    }else {	
	//buat query input ke calon_santri
	$daftar = "insert into calon_santri (ID_ORTU, EMAIL, ID_KEC, NAMA_CS, TEMPAT_LHR_CS, TGL_LHR_CS, NO_HP_CS, ALAMAT_CS, JK_CS, KULIAH, JURUSAN, SEMESTER, STATUS, FOTO)
	values('$lastId' ,'$lastIdAkun' ,'$nama7' ,'$nama1','$nama18' ,'$nama2' ,'$nama3' ,'$nama5' ,'$nama6' ,'$nama8' ,'$nama9' ,'$nama10', 'BELUM AKTIF','$file')";
	...
	echo 
	"<script>window.alert('Anda berhasil melakukan pendaftaran')</script>";
	}
?>
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                     ...
                     <div class="form-group">
                      ...
                      <div class="item form-group">
                        <label for="kuliah" class="control-label col-md-3">Kuliah<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label for="nama_ayah" class="control-label col-md-3 col-sm-3 col-xs-12">Nama Ayah<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label for="telp_ayah" class="control-label col-md-3 col-sm-3 col-xs-12">Telphone Ayah<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label for="pekerjaan_ayah" class="control-label col-md-3 col-sm-3 col-xs-12">Pekerjaan Ayah<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label for="nama_ibu" class="control-label col-md-3 col-sm-3 col-xs-12">Nama Ibu<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label for="telp_ibu" class="control-label col-md-3 col-sm-3 col-xs-12">Telephone Ibu<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label for="pekerjaan_ibu" class="control-label col-md-3 col-sm-3 col-xs-12">Pekerjaan Ibu<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label for="alamat_ortu" class="control-label col-md-3 col-sm-3 col-xs-12">Alamat Orang Tua<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="alamat_ortu" type="text" name="ALAMAT_ORTU" data-validate-length="50" class="form-control col-md-7 col-xs-12">* kosongi jika alamat orang tua sama dengan alamat calon santri
                        </div>
                       </div>
